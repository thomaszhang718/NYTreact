	...
	var Search = React.createClass({
		...
		render: function render() {
			...
			if (this.state.isDisplayed) {
				view = React.createElement(Results, { fiveArticles: this.state.fiveArticles });
			}
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement('input', { type: 'number', className: 'form-control', id: 'startYear' })
									),
									React.createElement(
										'div',
										{ className: 'form-group' },
										...
										React.createElement('input', { type: 'number', className: 'form-control', id: 'endYear' })
									),
									React.createElement(
										'button',
										{ className: 'btn btn-default', id: 'runSearch', type: 'button', onClick: this.searchArticles },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Results = React.createClass({
	  ...
	  saveArticle: function saveArticle(value) {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'h3',
	          null,
	          this.props.fiveArticles[0].headline
	        ),
	        React.createElement(
	          'h5',
	          null,
	          this.props.fiveArticles[0].date
	        ),
	        React.createElement(
	          'h5',
	          null,
	          React.createElement(
	            'a',
	            { href: this.props.fiveArticles[0].url },
	            'Link'
	          )
	        ),
	        React.createElement(
	          'button',
	          {
	            ...
	            onClick: this.saveArticle.bind(null, this.props.fiveArticles[0]) },
	          'Save Me'
	        )
	      ),
	      React.createElement('hr', null),
	      React.createElement(
	        ...
	        React.createElement(
	          'h3',
	          null,
	          this.props.fiveArticles[1].headline
	        ),
	        React.createElement(
	          'h5',
	          null,
	          this.props.fiveArticles[1].date
	        ),
	        React.createElement(
	          'h5',
	          null,
	          React.createElement(
	            'a',
	            { href: this.props.fiveArticles[1].url },
	            'Link'
	          )
	        ),
	        React.createElement(
	          'button',
	          {
	            ...
	            onClick: this.saveArticle.bind(null, this.props.fiveArticles[1]) },
	          'Save Me'
	        )
	      ),
	      React.createElement('hr', null),
	      React.createElement(
	        ...
	        React.createElement(
	          'h3',
	          null,
	          this.props.fiveArticles[2].headline
	        ),
	        React.createElement(
	          'h5',
	          null,
	          this.props.fiveArticles[2].date
	        ),
	        React.createElement(
	          'h5',
	          null,
	          React.createElement(
	            'a',
	            { href: this.props.fiveArticles[2].url },
	            'Link'
	          )
	        ),
	        React.createElement(
	          'button',
	          {
	            ...
	            onClick: this.saveArticle.bind(null, this.props.fiveArticles[2]) },
	          'Save Me'
	        )
	      ),
	      React.createElement('hr', null),
	      React.createElement(
	        ...
	        React.createElement(
	          'h3',
	          null,
	          this.props.fiveArticles[3].headline
	        ),
	        React.createElement(
	          'h5',
	          null,
	          this.props.fiveArticles[3].date
	        ),
	        React.createElement(
	          'h5',
	          null,
	          React.createElement(
	            'a',
	            { href: this.props.fiveArticles[3].url },
	            'Link'
	          )
	        ),
	        React.createElement(
	          'button',
	          {
	            ...
	            onClick: this.saveArticle.bind(null, this.props.fiveArticles[3]) },
	          'Save Me'
	        )
	      ),
	      React.createElement('hr', null),
	      React.createElement(
	        ...
	        React.createElement(
	          'h3',
	          null,
	          this.props.fiveArticles[4].headline
	        ),
	        React.createElement(
	          'h5',
	          null,
	          this.props.fiveArticles[4].date
	        ),
	        React.createElement(
	          'h5',
	          null,
	          React.createElement(
	            'a',
	            { href: this.props.fiveArticles[4].url },
	            'Link'
	          )
	        ),
	        React.createElement(
	          'button',
	          {
	            ...
	            onClick: this.saveArticle.bind(null, this.props.fiveArticles[4]) },
	          'Save Me'
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Delete = __webpack_require__(246);
	...
	var Saved = React.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			axios.get('/api/saved').then(function (savedData) {
		...
		render: function render() {
			...
			var articlesList = savedArticlesArray.map(function (articleInfo) {
				return React.createElement(
					...
					React.createElement(Delete, { value: articleInfo._id }),
					React.createElement('hr', null)
				);
			});
	...
	var Delete = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { className: 'btn btn-default deleteButton', value: this.props.value, onClick: this.deleteArticle.bind(null, this.props.value) },
	        'Delete Article'
	      )
	    );
	  }
